...
<head>
    ...
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/slick.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/slick-theme.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/bootstrap.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/home.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/layout.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/layout.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/assets/css/all.min.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/remixicon.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/jquery-ui.min.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/selectize.min.css') }}"> --}}
    {{--    <link rel="stylesheet" href="{{ asset('public/web_front/css/style.css') }}"> --}}
    <link rel="stylesheet" href="{{ asset('public/css/front-third-party.css') }}">
    <link rel="stylesheet" href="{{ asset('public/css/front-pages.css') }}">
    ...
    {{-- <script src="{{ asset('public/livewire/livewire.js') }}" data-turbolinks-eval="false" data-turbo-eval="false"></script> --}}
    ...
    <script src="{{ asset('public/js/front-third-party.js') }}"></script>
    ...
    <script src="{{ asset('public/js/front-pages.js') }}"></script>
    @yield('page_scripts')
    <script>
