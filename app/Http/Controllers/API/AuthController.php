...
class AuthController extends AppBaseController
{
    ...
    public function sendPasswordResetLinkEmail(Request $request): JsonResponse
    {
        ...
        // $data['link'] = 'https://DHCflutter.page.link/?link=http://com.example.DHC_flutter/'.$data['token'].'&apn=com.example.DHC_flutter';

        $data['link'] = $request->url_domain.'//hms.com/createNewPassword?token='.$data['token'].'&email='.$request->email.'&apn=com.example.DHC_flutter';
